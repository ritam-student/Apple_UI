...
function Div1() {
    return (
      ...
      w-full h-[500px] md:h-[600px] object-cover bg-no-repeat text-white">
        ...
        <h1 className="text-white  font-semibold text-5xl tracking-tighter leading-[50px] mt-10 ">iPhone 16 Pro</h1>
